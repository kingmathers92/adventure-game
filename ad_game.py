...
def intro(enemies):
    ...
    print_pause(f"Rumor has it that a wicked {enemy} is somewhere around here, and has been terrifying the nearby village.")


def house(weapons, enemies):
    ...
    if '1' in choice:
        ...
        if "sword" in weapons:
            print_pause("He sees your magic sword, he can't beat that so he get scared and runs way")
            print_pause("YOU WIN!!!")
        else:
            print_pause(f"You try to fight the {enemy} with your weak dagger..")    
